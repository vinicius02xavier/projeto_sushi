...
class TelaCombinado01 extends StatefulWidget {
  const TelaCombinado01({Key? key}) : super(key: key);

  @override
  State<TelaCombinado01> createState() => _TelaCombinado01State();
}

class _TelaCombinado01State extends State<TelaCombinado01> {
  @override
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage("Images/combinado01.jpeg"),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    final newItem = Item(nome: "Combinado 01", valor: 120.0);
